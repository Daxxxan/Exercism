...
namespace Leap
{
    public class LeapTest
    {
        ...
        {
            Assert.False(global::Leap.Leap.IsLeapYear(1970));
        }

        [Fact]
        public void Year_divisible_by_4_not_divisible_by_100_in_leap_year()
        {
            Assert.True(global::Leap.Leap.IsLeapYear(1996));
        }

        [Fact]
        public void Year_divisible_by_4_and_5_is_still_a_leap_year()
        {
            Assert.True(global::Leap.Leap.IsLeapYear(1960));
        }
        ...
        {
            Assert.False(global::Leap.Leap.IsLeapYear(1900));
        }
        ...
        {
            Assert.True(global::Leap.Leap.IsLeapYear(2400));
        }

        [Fact]
        public void Year_divisible_by_200_not_divisible_by_400_in_common_year()
        {
            Assert.False(global::Leap.Leap.IsLeapYear(1800));
        }
    }
}